...
API_KEY = '00214978166846eba14c5326a69a3e39'

# Google Custom Search API details
GOOGLE_API_KEY = "AIzaSyAC-A5BYtSWNy2obfZ711XetDnvHsBwnQQ"  # Replace with your API key
GOOGLE_CX = "54200e765c421489a"  # Replace with your custom search engine ID
...
st.markdown('<h1 class="centered-header">GRADPATH Job Recommender</h1>', unsafe_allow_html=True)
